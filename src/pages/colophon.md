...
Vienna time is computed in the browser. Weather is fetched from this site (`/api/weather`), which caches a Vienna forecast from [Open-Meteo](https://open-meteo.com/) for 15 minutes. No API key, no cookies.
...
- [Open-Meteo](https://open-meteo.com/): Vienna temperature, fetched by the Worker and cached for 15 minutes
