...
- **Collaborators:** <ExternalLink href="https://twitter.com/Maybach">Patrick Ludewig</ExternalLink>, <ExternalLink href="http://beyondbureaucracy.org/">Alois Paulin</ExternalLink>, Vlad
- **Timeline:** April 2023 - 
- **Status:** active
- **Stack:** Typescript, Vite, Remix, Tailwind, C#, SQLite.

## What is hausgemacht?
__hausgemacht__ ("homemade" in German) is the biggest techno collective in Vienna. They organize events in various clubs in the city.
...
A big focus of __hausgemacht__ is creating a safe space for FLINTA\* people. There are awareness teams at the events looking after the safety and well-being of the guests.
...
I met up with the Internet team we could get to know each other and talk about the projects they were working on. Afterwards I was invited to join the collective.
